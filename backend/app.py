...
def page_not_found(e):
    ...
    logger.warning(f"404 Error: User tried to access {request.path}")
    
    # Returning the error message as a JSON object 
    return jsonify({
        "status": "error",
        "statusCode": 404,
        "message": "The requested resource/route was not found on this server.",
