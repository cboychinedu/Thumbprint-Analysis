              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <section className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-indigo-700 mt-1 leading-relaxed">
                          Upload a <strong>.zip</strong> file containing folders
                          of thumbprints. The folder names will be used as labels
                          (e.g., /John_Doe/image1.jpg).
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      {isTraining
                        ? "Injecting Neural Data..."
                        : "Execute Model Retraining"}
                    </button>

                    {uploadStatus && (
                      <div
                        className={`mt-4 p-4 rounded-lg text-xs font-mono font-bold uppercase ${uploadStatus.status === "success" ? "bg-teal-50 text-teal-700" : "bg-red-50 text-red-700"}`}
                      >
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between py-4 border-b border-slate-50">
                      <div>
                        ...
                        <p className="text-[10px] text-slate-400 uppercase font-mono">
                          Store all biometric scans in database
                        </p>
                      </div>
                    ...
                    <div className="flex items-center justify-between py-4 border-b border-slate-50">
                      <div>
                        ...
                        <p className="text-[10px] text-slate-400 uppercase font-mono">
                          Increase neural layer depth (Slower latency)
                        </p>
                      </div>
