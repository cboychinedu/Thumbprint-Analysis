...
const Dashboard = () => {
  ...
  // Creating a function for loading the user's profile
  const fetchProfile = async () => {
    ...
    try {
      ...
      // Else set the value as null
        ...
        // setting the null point value
        setUser(null);
      }
    } catch (error) {
      // Catch the error
      console.log("Failed to load the profile: ", error);
      setUser(null);
    }
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setInferenceResult({
        status: "error",
        message: "Connection to ML Server failed.",
      });
    } finally {
            ...
            <div>
              ...
              <section>
                ...
                <div className="space-y-1 mb-[20px]">
                  <select className="w-[200px] bg-slate-50 border border-blue-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all appearance-none">
                    <option> Select ML Model </option>
                    <option> Default Model </option>
                  </select>
                  <p className="text-slate-500 text-[12px] mt-1">
                    {" "}
                    <strong> N/B: </strong> Remember, if you do not select a
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                  ...
                  <section className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
                    <div className="flex items-center gap-2 mb-6">
                      ...
                      <h2 className="text-sm font-bold uppercase tracking-widest text-slate-700 font-mono">
                        Data Input
                      </h2>
                    </div>
                      ...
                      {previewUrl ? (
                        <div className="space-y-4">
                          <img
                            src={previewUrl}
                            alt="Preview"
                            className="mx-auto max-h-64 rounded-lg border border-white shadow-md"
                          />
                          <button
                            onClick={() => {
                              setPreviewUrl(null);
                        ...
                        >
                          <svg
                            className="w-12 h-12 mx-auto text-slate-300 mb-4 group-hover:text-indigo-500 transition-colors"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                    ...
                    <div className="bg-slate-50/50 border border-slate-200 rounded-2xl p-8 min-h-[440px] flex flex-col shadow-inner">
                      ...
                      {inferenceResult ? (
                        <div className="flex-1 flex flex-col justify-center animate-in slide-in-from-bottom-4 duration-500">
                          {inferenceResult.status === "success" ? (
                              ...
                              <div className="flex items-center gap-5 mb-6">
                                ...
                                <div>
                                  ...
                                  <h3 className="text-3xl font-bold text-slate-900 tracking-tight">
                                    {inferenceResult.predictedResult}
                                  </h3>
                                </div>
                              </div>
                            ...
                            <div className="bg-red-50 border border-red-100 p-6 rounded-xl text-center">
                              <p className="text-red-700 font-bold text-sm uppercase font-mono tracking-widest">
                                Scan Failed
                              </p>
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-center">
                          ...
                          <p className="text-slate-300 text-[10px] uppercase tracking-[0.3em] font-bold font-mono">
                            Awaiting Input Data
                          </p>
                        </div>
                      )}
